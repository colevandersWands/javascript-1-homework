...
| :seedling: __[errors: variables](./jl-errors-variables.md)__ |  :white_check_mark:| The key is understand that execution phase doestn have sintaxys error. | | |
| :seedling: __[varibales: swaps](./jl-variables-swaps.md)__ | :white_check_mark: | I finished It's no so hard | | |
