...
| --- | --- | --- | --- | --- |
| :seedling: __[fcc basics](./fcc-basic-js-pt-1.md)__: through ```Counting Cards``` |:white_check_mark: |excersice complited till **``` no 79.Counting Cards```** | | |
...
| :seedling: __[errors: variables](./jl-errors-variables.md)__ |:white_check_mark: |13. Is not a function on the completed example says classification:execution phase. but, when i check it in pythontutor it seems me creation phase  | | |
